(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 20028, (e, t, r) => {
    "use strict";
    var n = e.r(23674),
        u = {
            stream: !0
    ...
    function s(t) {
        for (var r = t[1], n = [], u = 0; u < r.length; u++) {
            var s = e.L(r[u]);
            if (l.has(s) || n.push(s), !a.has(s)) {
                var c = l.add.bind(l, s);
                s.then(c, i), a.add(s)
            }
        }
    ...
    function S(e, t, r) {
        for (var n = 0; n < t.length; n++) {
            var u = t[n];
            "function" == typeof u ? u(r) : L(e, u.handler, r)
        }
    }
            ...
            case "blocked":
                for (var u = 0; u < r.length; u++) {
                    ...
                    if ("function" != typeof o) {
                        var a = w(t, o);
                        if (null !== a) switch (F(e, o, a.value), r.splice(u, 1), u--, null !== n && -1 !== (o = n.indexOf(o)) && n.splice(o, 1), t.status) {
                            case "fulfilled":
                                O(e, r, t.value);
                                return;
                            case "rejected":
    ...
    function M(e, t, r) {
        if ("pending" !== t.status) t.reason.enqueueModel(r);
            ...
            var n = t.value,
                u = t.reason;
            t.status = "resolved_model", t.value = r, t.reason = e, null !== n && (U(t), P(e, t, n, u))
        }
    }
    ...
    function k(e, t, r) {
        if ("pending" === t.status || "blocked" === t.status) {
            var n = t.value,
                u = t.reason;
            t.status = "resolved_module", t.value = r, null !== n && (C(t), P(e, t, n, u))
        }
    }
        ...
        try {
            ...
            if (null !== o)
                for (e.value = null, e.reason = null, r = 0; r < o.length; r++) {
                    var a = o[r];
                    "function" == typeof a ? a(u) : F(n, a, u, e)
                }
            if (null !== N) {
    ...
    function F(e, t, r) {
        ...
        a = a(e, r, u, o), u[o] = a, "" === o && null === n.value && (n.value = a), u[0] === d && "object" == typeof n.value && null !== n.value && n.value.$$typeof === d && (u = n.value, "3" === o) && (u.props = a), n.deps--, 0 === n.deps && null !== (o = n.chunk) && "blocked" === o.status && (u = o.value, o.status = "fulfilled", o.value = n.value, o.reason = n.reason, null !== u && O(e, u, n.value))
    }
    ...
    function B(e, t, r, n) {
        ...
        if (o) t.bound && (o = Promise.all([o, t.bound]));
            ...
            if (!t.bound) return m(o = c(u), t.id, t.bound), o;
        ...
        return o.then(function() {
            ...
            m(o, t.id, t.bound), r[n] = o, "" === n && null === a.value && (a.value = o), r[0] === d && "object" == typeof a.value && null !== a.value && a.value.$$typeof === d && (l = a.value, "3" === n) && (l.props = o), a.deps--, 0 === a.deps && null !== (o = a.chunk) && "blocked" === o.status && (l = o.value, o.status = "fulfilled", o.value = a.value, null !== l && O(e, l, a.value))
        }, function(t) {
            if (!a.errored) {
        ...
        switch (o.status) {
            case "fulfilled":
                ...
                for (var a = 1; a < t.length; a++) {
                    for (;
                        "object" == typeof o && null !== o && o.$$typeof === p;) {
                        ...
                        switch (o.status) {
                            ...
                            case "blocked":
                            case "pending":
                                return x(o, r, n, e, u, t.slice(a - 1));
                            case "halted":
    ...
    function V(e, t, r, n, u, o, a) {
        var l, i = new Map;
        this._bundlerConfig = e, this._serverReferenceConfig = t, this._moduleLoading = r, this._callServer = void 0 !== n ? n : J, this._encodeFormAction = u, this._nonce = o, this._chunks = i, this._stringDecoder = new TextDecoder, this._fromJSON = null, this._closed = !1, this._closedReason = null, this._tempRefs = a, this._fromJSON = (l = this, function(e, t) {
            if ("string" == typeof t) {
                var r = l,
                    n = this,
                    u = e,
                ...
                if ("$" === o[0]) {
                    ...
                    switch (o[1]) {
                        case "$":
                            return o.slice(1);
                        case "L":
                            return D(r = $(r, n = parseInt(o.slice(2), 16)));
                        case "@":
                            return $(r, n = parseInt(o.slice(2), 16));
                        case "S":
                            return Symbol.for(o.slice(2));
                        case "F":
                            return H(r, o = o.slice(2), n, u, B);
                        case "T":
                            ...
                            return r.get(n);
                        case "Q":
                            return H(r, o = o.slice(2), n, u, Y);
                        case "W":
                            return H(r, o = o.slice(2), n, u, G);
                        case "B":
                            return H(r, o = o.slice(2), n, u, W);
                        case "K":
                            return H(r, o = o.slice(2), n, u, X);
                        case "Z":
                            return er();
                        case "i":
                            return H(r, o = o.slice(2), n, u, K);
                        case "I":
                            return 1 / 0;
                        case "-":
                            return "$-0" === o ? -0 : -1 / 0;
            ...
            if ("object" == typeof t && null !== t) {
                if (t[0] === d) {
                    if (e = {
                        ...
                        if (N = (t = N).parent, t.errored) e = D(e = new E("rejected", null, t.reason));
                        else if (0 < t.deps) {
    ...
    function z(e, t, r, n) {
        var u = e._chunks,
            o = u.get(t);
        o ? "pending" === o.status && (t = o.value, o.status = "fulfilled", o.value = r, o.reason = n, null !== t && O(e, t, o.value)) : (e = new E("fulfilled", r, n), u.set(t, e))
    }
    ...
    function et(e, t, r) {
        ...
        a[v] = function() {
            ...
            enqueueModel: function(t) {
                o === n.length ? n[o] = j(e, t, !1) : A(e, n[o], t, !1), o++
            },
            close: function(t) {
                for (u = !0, o === n.length ? n[o] = j(e, t, !0) : A(e, n[o], t, !0), o++; o < n.length;) A(e, n[o++], '"$undefined"', !0)
            },
            error: function(t) {
                for (u = !0, o === n.length && (n[o] = new E("pending", null, null)); o < n.length;) T(e, n[o++], t)
            }
        })
    }
    ...
    function eu(e, t, r, n, u, o) {
        Q(e, t, u = new u((r = 0 === r.length && 0 == n.byteOffset % o ? n : en(r, n)).buffer, r.byteOffset, r.byteLength / o))
    }
    ...
    function el(e, t, r) {
        ...
        a.read().then(function t(l) {
            ...
            var c = 0,
                d = o._rowState;
            l = o._rowID;
            for (var p = o._rowTag, h = o._rowLength, v = o._buffer, _ = i.length; c < _;) {
                var y = -1;
                switch (d) {
                    case 0:
                        58 === (y = i[c++]) ? d = 1 : l = l << 4 | (96 < y ? y - 87 : y - 48);
                        continue;
                    case 1:
                        84 === (d = i[c]) || 65 === d || 79 === d || 111 === d || 85 === d || 83 === d || 115 === d || 76 === d || 108 === d || 71 === d || 103 === d || 77 === d || 109 === d || 86 === d ? (p = d, d = 2, c++) : 64 < d && 91 > d || 35 === d || 114 === d || 120 === d ? (p = d, d = 3, c++) : (p = 0, d = 3);
                        continue;
                    case 2:
                        44 === (y = i[c++]) ? d = 4 : h = h << 4 | (96 < y ? y - 87 : y - 48);
                        continue;
                    case 3:
                        y = i.indexOf(10, c);
                        break;
                ...
                if (-1 < y)(function(e, t, r, n, o, a) {
                    switch (n) {
                        case 65:
                            ...
                            return;
                        case 79:
                            eu(e, r, o, a, Int8Array, 1);
                            return;
                        case 111:
                            Q(e, r, 0 === o.length ? a : en(o, a));
                            return;
                        case 85:
                            eu(e, r, o, a, Uint8ClampedArray, 1);
                            return;
                        case 83:
                            eu(e, r, o, a, Int16Array, 2);
                            return;
                        case 115:
                            eu(e, r, o, a, Uint16Array, 2);
                            return;
                        case 76:
                            eu(e, r, o, a, Int32Array, 4);
                            return;
                        case 108:
                            eu(e, r, o, a, Uint32Array, 4);
                            return;
                        case 71:
                            eu(e, r, o, a, Float32Array, 4);
                            return;
                        case 103:
                            eu(e, r, o, a, Float64Array, 8);
                            return;
                        case 77:
                            eu(e, r, o, a, BigInt64Array, 8);
                            return;
                        case 109:
                            eu(e, r, o, a, BigUint64Array, 8);
                            return;
                        case 86:
                            eu(e, r, o, a, DataView, 1);
                            return
                    }
                    t = e._stringDecoder;
                    ...
                    switch (o = l += t.decode(a), n) {
                        case 73:
                            ...
                            } else v ? k(c, v, _) : (v = new E("resolved_module", _, null), h.set(d, v));
                            break;
                        case 72:
                            switch (r = o[0], e = JSON.parse(o = o.slice(1), e._fromJSON), o = f.d, r) {
                                case "D":
                                    o.D(e);
                                    break;
                                case "C":
                            ...
                            break;
                        case 69:
                            a = (n = e._chunks).get(r), o = JSON.parse(o), (t = er()).digest = o.digest, a ? T(e, a, t) : (e = new E("rejected", null, t), n.set(r, e));
                            break;
                        case 84:
                            (n = (e = e._chunks).get(r)) && "pending" !== n.status ? n.reason.enqueueValue(o) : (o = new E("fulfilled", o, null), e.set(r, o));
                            break;
                        case 78:
                        case 68:
                        case 74:
                        ...
                        case 67:
                            ...
                            break;
                        default:
                            (a = (n = e._chunks).get(r)) ? M(e, a, o): (e = new E("resolved_model", o, e), n.set(r, e))
                    }
                })(e, o, l, p, v, h = new Uint8Array(i.buffer, b, y - c)), c = y, 3 === d && c++, h = l = p = d = 0, v.length = 0;
                else {
                    i = new Uint8Array(i.buffer, b, i.byteLength - c), v.push(i), h -= i.byteLength;
                    break
                }
            }
            return o._rowState = d, o._rowID = l, o._rowTag = p, o._rowLength = h, a.read().then(t).catch(n)
        }).catch(n)
    }
    r.createFromFetch = function(e, t) {
        var r = ea(t);
        return e.then(function(e) {
            el(r, e.body, eo.bind(null, r))
        }, function(e) {
            I(r, e)
        }), $(r, 0)
    }, r.createFromReadableStream = function(e, t) {
        return el(t = ea(t), e, eo.bind(null, t)), $(t, 0)
            ...
            var u = function(e, t, r, n, u) {
                ...
                function a(e, t) {
                    ...
                    if ("object" == typeof t) {
                        ...
                        if (e = null === (E = t) || "object" != typeof E ? null : "function" == typeof(E = h && E[h] || E["@@iterator"]) ? E : null) return (P = e.call(t)) === t ? (e = i++, P = l(Array.from(P), e), null === c && (c = new FormData), c.append("" + e, P), "$i" + e.toString(16)) : Array.from(P);
                        ...
                        if ("function" == typeof(e = t[v])) return R = t, O = e.call(t), null === c && (c = new FormData), S = c, s++, w = i++, R = R === O, O.next().then(function e(t) {
                            if (t.done) {
                    ...
                    if ("function" == typeof t) {
                        if (void 0 !== (P = g.get(t))) return e = JSON.stringify({
                            id: P.id,
                            bound: P.bound
    ...
    async function g(e, t) {
        ...
        try {
            ...
            let R = await g;
            if ((0, d.getAppBuildId)() !== R.b) return y(r.url);
            ...
            return b.signal.aborted || console.error(`Failed to fetch RSC payload for ${e}. Falling back to browser navigation.`, t), e.toString()
        }
    }
